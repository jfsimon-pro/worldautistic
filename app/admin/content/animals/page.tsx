...
export default function AnimalsManagement() {
    ...
    const fetchAnimals = async () => {
        try {
            const res = await fetch('/api/admin/cards?category=ANIMALS');
            ...
            <div style={{ backgroundColor: '#fff', borderBottom: '1px solid #e0e0e0', padding: '1.5rem 2rem' }}>
                <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <h1 style={{ fontSize: '1.75rem', color: '#2c3e50', margin: 0 }}>🦁 Gerenciar Animais</h1>
                        <button
            ...
            {isModalOpen && (
                <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0,0,0,0.5)', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                    <div style={{ backgroundColor: '#fff', padding: '2rem', borderRadius: '12px', width: '100%', maxWidth: '500px' }}>
                        <h2 style={{ marginTop: 0 }}>{editingCard ? 'Editar Animal' : 'Novo Animal'}</h2>
                                ...
                                <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
                                    <input
                                        ...
                                        onChange={async (e) => {
                                            ...
                                            uploadData.append('folder', 'animals');
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={async (e) => {
                                        ...
                                        const uploadData = new FormData();
                                        uploadData.append('file', file);
                                        uploadData.append('folder', 'audio/animals'); // Pasta específica
